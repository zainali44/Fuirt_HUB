...
export default function Userlogin({ navigation }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ flexDirection: "row", marginTop: 20, justifyContent: "flex-end", gap: 30, paddingLeft: 20, paddingRight: 20, paddingTop: 10, borderRadius: 10, width: 350, fontSize: 20, fontWeight: "semibold", color: "grey" }}>
                <View style={{ alignItems: "flex-end" }}>
                    <TouchableOpacity onPress={() => navigation.navigate('New Registration')}>
                        <View style={{ flexDirection: "row", gap: 2 }}>
                            <Text style={{ color: "#8391A1" }}>Don't have an account? </Text>
                            <Text style={{ flexDirection: "row", color: "#8391A1", fontWeight: "bold" }}>Register Now</Text>
                        </View>
                    </TouchableOpacity>
                </View>
            </View>
            ...
            <View style={{ flexDirection: "row", marginTop: 30, justifyContent: "center", gap: 30, paddingLeft: 20, paddingRight: 20, paddingTop: 10, borderRadius: 10, width: 350, fontSize: 20, fontWeight: "semibold", color: "grey" }}>
                <View style={{ alignItems: "flex-end" }}>
                    <TouchableOpacity onPress={() => navigation.navigate('Admin Login')}>
                        <View style={{ flexDirection: "row", gap: 2 }}>
                            <Text style={{ color: "#8391A1" }}>Continue as a </Text>
                            <Text style={{ flexDirection: "row", color: "#8391A1", fontWeight: "bold" }}>ADMIN</Text>
                        </View>
                    </TouchableOpacity>
                </View>
            </View>
